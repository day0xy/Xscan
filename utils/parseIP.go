...
// ParseIP Choose the way to resolve IP according to IP address format
...
// ParseIPB Resolving multiple IPS, for example: 192.168.111.1,192.168.111.2
...
// ParseIPC Resolving a range of IP,for example: 192.168.111.1-255
